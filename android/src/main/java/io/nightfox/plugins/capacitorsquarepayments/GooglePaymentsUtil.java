...
public class GooglePaymentsUtil {
    ...
    public static Optional<JSONObject> getPaymentDataRequest(long priceCents) {
        ...
        final String price = GooglePaymentsUtil.centsToString(priceCents);

        try {
            JSONObject paymentDataRequest = GooglePaymentsUtil.getBaseRequest();
            paymentDataRequest.put(
                    "allowedPaymentMethods", new JSONArray().put(GooglePaymentsUtil.getCardPaymentMethod()));
            paymentDataRequest.put("transactionInfo", GooglePaymentsUtil.getTransactionInfo(price));
            paymentDataRequest.put("merchantInfo", GooglePaymentsUtil.getMerchantInfo());
    ...
    /**
     * Converts cents to a string format accepted by {@link GooglePaymentsUtil#getPaymentDataRequest}.
     *
